...
public class Myseatbusiness   extends ArrayAdapter<seatbusiness> {

    String std="";
    public Myseatbusiness(Context context, ArrayList<seatbusiness> objects) {
        super(context, R.layout.list_business, objects);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
       final Viewholder viewholder;
        ...
        convertView = jusainflator.inflate(R.layout.list_business, parent, false);
        viewholder.a=(Button)convertView.findViewById(R.id.button_bus_a);
        viewholder.d=(Button)convertView.findViewById(R.id.button_bus_d);
        viewholder.c=(Button)convertView.findViewById(R.id.button_bus_c);
        viewholder.h=(Button)convertView.findViewById(R.id.button_bus_h);
        viewholder.g=(Button)convertView.findViewById(R.id.button_bus_g);
        viewholder.k=(Button)convertView.findViewById(R.id.button_bus_k);


        seatbusiness st=getItem(position);
