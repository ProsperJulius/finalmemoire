...
public class Rechercher extends AppCompatActivity {
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_rechercher, container, false);
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
             switch(position){
                 case 0:
                     Tabchercheraller aller=new Tabchercheraller();
                     return aller;
                 case 1:Tabchercherretour aller_retour=new Tabchercherretour();
                     return aller_retour;
